...
public class Order {
    ...
    private DateTime date; // The date of the Order.
     ...
     */
    public Order(OrderType signal, String companyName, double price, int volume, DateTime date){
        this.signal = signal;
    ...
    public String[] toStringArray() {
        ...
        s[1] = DateUtils.formatMonthAbbr(this.date);

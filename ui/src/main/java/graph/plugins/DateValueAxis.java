...
public class DateValueAxis extends ValueAxis<Long> {
    ...
    /**
     * Create a auto-ranging graph.plugins.DateAxis
     */
    ...
    /**
     * Create a non-auto-ranging graph.plugins.DateAxis with the given upper bound, lower bound and tick unit
     *
...
//        // pad min and max by 2%, checking if the range is zero
    ...
    /**
     * Default number formatter for graph.plugins.DateAxis, this stays in sync with auto-ranging and formats values appropriately.
    ...
    public static class DefaultFormatter extends StringConverter<Long> {
        ...
        /**
         * Construct a DefaultFormatter for the given graph.plugins.DateAxis
         *
        ...
        /**
         * Construct a DefaultFormatter for the given graph.plugins.DateAxis with a prefix and/or suffix.
         *
         * @param axis The axis to format tick marks for
        ...
        private static TimeStringConverter getFormatter(int rangeIndex) {
            if (rangeIndex < 0) {
                return new TimeStringConverter("dd/MM/yy");

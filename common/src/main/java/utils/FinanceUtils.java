...
public class FinanceUtils {
    public static double calcReturns(double currPrice, double prevPrice)
    {
        return (currPrice - prevPrice)/prevPrice;
    }

    public static List<Double> calcAllReturns (List<Double> prices)
    {
    ...
    public static double calcSimpleMovingAvg(List<Double> returns, int n, int t)
    {
        double returnSum = 0;
    ...
    public static double calcSharpeRatio (List<Double> returns, DateTime startDate, DateTime endDate) {
        ...
        double averageReturnPeriod = totalNumOfDays / (double)returnPercents.size();

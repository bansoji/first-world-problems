...
/**
 * THIS IS FOR TESTING PURPOSES ONLY. Since there are limited examples of spider charts available
 * for jfreecharts.
 */
...
public class ProfilingChart extends ApplicationFrame {

    private static final long serialVersionUID = 1L;

    public ProfilingChart(String s) {
        super(s);
...
//        dataset.addValue(6D, s2, s7);
    ...
    public static void main(String args[]) {
        ProfilingChart spiderwebchartdemo1 = new ProfilingChart("SpiderWebChartDemo1");
